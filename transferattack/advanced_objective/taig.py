...
class TAIG(BaseAttack):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/taig/resnet50 --attack taig --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/taig/resnet50 --eval
    """
