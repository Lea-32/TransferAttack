...
class GNP(BaseAttack):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/gnp/resnet50 --attack gnp --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/gnp/resnet50 --eval
    """
