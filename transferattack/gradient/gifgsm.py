...
class GIFGSM(BaseAttack):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/gifgsm/resnet50 --attack gifgsm --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/gifgsm/resnet50 --eval
    """
