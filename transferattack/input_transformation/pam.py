...
class PAM(MIFGSM):
    ...
    Example script:
        python main.py --input_dir ./path/to/data --output_dir adv_data/pam/resnet50 --attack pam --model=resnet50
        python main.py --input_dir ./path/to/data --output_dir adv_data/pam/resnet50 --eval
    """
